...
当你点开某个联系人，对面回复的是 **经由本机调用大模型** 的真实角色对话。
...
虽然还没弄完，功能不够完善ui也丑丑的，后续有时间会优化的咕咕咕（其实大部分是cursor帮我写的）
|ू･ω･` )
